...
const buttonClassName = 'border rounded py-1 px-2 inline-block hover:bg-gray-200'
...
const ReloadPrompt = (): JSX.Element | null => {
  ...
  return needReload ? (
    <div className="bg-white border rounded space-y-2 shadow m-4 py-2 px-4 right-0 bottom-0 fixed">
